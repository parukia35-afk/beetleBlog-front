  ...
  <v-app class="bg-background">
      ...
      <v-container fluid class="d-flex align-center">
        ...
        <v-col cols="auto" class="d-flex align-center ga-1">
          ...
          <v-btn
            ...
            color="on-background"
            variant="text"
            class="btn-size d-none d-sm-flex"
          >
          ...
          <v-btn
            icon
            to="/cart"
            class="mr-2 btn-size d-none d-sm-flex"
            title="購物車"
            color="on-background"
            variant="text"
          >
    ...
    >
      <div class="d-flex flex-column">
        ...
        <!-- 小螢幕才顯示的功能捷徑 -->
        <v-divider class="my-3 d-sm-none" />

        <v-list nav density="comfortable" class="d-sm-none">
          <v-list-item
    ...
    <v-footer
      app
      height="250"
      class="text-center d-flex flex-column justify-center border-t border-opacity-12"
    >
      <div class="mb-4">
        <v-btn
      ...
      <div class="mb-4 text-body-2 text-medium-emphasis mx-auto" style="max-width: 500px">
...
const { name, width: windowWidth } = useDisplay() // 用JS抓視窗寬度，控制漢堡選單彈出的寬度
